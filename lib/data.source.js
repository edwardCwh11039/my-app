  ...
  titleWrapper: {
    ...
    children: [
      { name: "title", children: "Our Story", className: "title-h1" },
      {
        ...
        children: (
          <p>
            Kinta offers an extensive range of pre-owned quality Used Trucks for
            sale in Melbourne, Sydney, Brisbane, Adelaide & Perth. We have one
            of the largest ranges of Used Trucks to select from combined with
            multiple locations around Australia, to make purchasing your next
            truck an effortless experience. Our experienced Used Truck team have
            a well-earned reputation of providing quality pre- owned trucks that
            have been sourced to meet our customers need. The purchasing of
            Used Trucks is a serious business and our experienced team source
